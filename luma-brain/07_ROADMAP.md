...
- [~] **Pilha de efeitos múltiplos (2026-08-13, formas entregues).** Photoshop aceita 2+ sombras, contornos e overlays na mesma camada; o importador guardava só o primeiro. Formas agora carregam `layerEffects` com todas as sombras projetadas/internas, sobreposições de cor/gradiente e contornos sólidos, mantendo a ordem dentro de cada tipo; export e prévia compõem a pilha, contornos externos ficam atrás do fill e internos na frente, e a revisão mostra quantos efeitos foram preservados. O painel enxuto edita a primeira instância e “Remover efeitos” apaga a pilha inteira. QA sintético cobriu parse de quatro instâncias, overlays sequenciais e contornos interno+externo; o PSD real ficou estável em 98,32% / 95,16% / 99,24%. **Resíduo:** pilha em texto/imagem continua imagem fiel com aviso; blend não normal é sinalizado como aproximação; gradiente/pattern em contorno continua sem primitiva dinâmica.
