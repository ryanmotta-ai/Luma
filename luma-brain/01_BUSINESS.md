...
- ⛔ **O BLOCO do preço também não é EMPURRADO** (regra de 03/09/2026, a outra metade da de cima). O preço não encolhia, mas ainda descia: num material medido, ele deslizava 240px do lugar que o designer deu conforme o nome do produto crescia — a base sólida atrás dele descia junto, e num padrão "De R$ X por R$ Y" o "de" se separava do valor. Agora o bloco todo fica onde foi desenhado; quem cede espaço é o texto de apoio. Duas réguas diferentes de propósito: **encolher** segue a categoria do campo (a régua estreita de 19/08), **ser empurrado** vale para o bloco (o papel compilado `layoutSemantic`) — usar a régua larga nas duas invertia a hierarquia entre o "de" e o cupom, pego pelo corpus. Consequência aceita e medida: o apoio encolhe mais cedo (num nome de produto de 58 caracteres, "detalhes" cai de 31px para 17px).
