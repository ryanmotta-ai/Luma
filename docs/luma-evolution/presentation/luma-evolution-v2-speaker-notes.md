...
43 slides. Somando as durações das notas dá cerca de 15 minutos falando; dá pra cortar os slides de era e ficar em 10.
...
Página 1 de 6 do histórico completo. Não leia em voz alta — está aqui para quem quiser conferir depois.
Se alguém perguntar por um commit específico, é nestes slides que ele está.
~15s.

## Slide 08

Página 2 de 6 do histórico completo. Não leia em voz alta — está aqui para quem quiser conferir depois.
Se alguém perguntar por um commit específico, é nestes slides que ele está.
~15s.

## Slide 09

Página 3 de 6 do histórico completo. Não leia em voz alta — está aqui para quem quiser conferir depois.
Se alguém perguntar por um commit específico, é nestes slides que ele está.
~15s.

## Slide 10

Página 4 de 6 do histórico completo. Não leia em voz alta — está aqui para quem quiser conferir depois.
Se alguém perguntar por um commit específico, é nestes slides que ele está.
~15s.

## Slide 11

Página 5 de 6 do histórico completo. Não leia em voz alta — está aqui para quem quiser conferir depois.
Se alguém perguntar por um commit específico, é nestes slides que ele está.
~15s.

## Slide 12

Página 6 de 6 do histórico completo. Não leia em voz alta — está aqui para quem quiser conferir depois.
Se alguém perguntar por um commit específico, é nestes slides que ele está.
~15s.
...
A comparação mais reveladora do bloco. O quadro da esquerda é 16/06: o Luma no dia em que entrou no git, com o layout herdado do piloto e só a cor trocada.
A vitrine aparece em julho — foi ela que deu onde morar ao destaque, à busca e ao histórico.
~50s.

## Slide 16

O quadro da esquerda é honesto sobre o estágio de junho: a estrutura existia, o conteúdo não.
...
O slide mais forte do bloco, e agora com o estágio que faltava: em junho o Estúdio era só o canvas — abria com a prancheta preta e as ferramentas em volta.
...
Panorama 1 de 3: Criar material, Importar PSD, Atalhos do Estúdio.
Não descreva tela por tela — deixe a imagem falar e diga que tudo saiu da mesma versão, no mesmo dia.
~30s.

## Slide 40

Panorama 2 de 3: Campanha no celular, , Tema Much+.
Não descreva tela por tela — deixe a imagem falar e diga que tudo saiu da mesma versão, no mesmo dia.
~30s.

## Slide 41

Panorama 3 de 3: Vitrine, Estúdio, Console do time.
Não descreva tela por tela — deixe a imagem falar e diga que tudo saiu da mesma versão, no mesmo dia.
~30s.
