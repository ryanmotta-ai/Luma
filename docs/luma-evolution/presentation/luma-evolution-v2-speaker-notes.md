...
39 slides. Somando as durações das notas dá cerca de 15 minutos falando; dá pra cortar os slides de era e ficar em 10.
...
O histórico versionado é curto: 15 dias, 74 commits, e metade deles no primeiro dia. A forma que importa é: um piloto, uma fundação enorme, duas semanas de refino e um salto de capacidade no fim.
~50s.
...
Panorama 1 de 3: Vitrine, Campanha aberta, Chat que monta a arte.
Não descreva tela por tela — deixe a imagem falar e diga que tudo saiu da mesma versão, no mesmo dia.
~30s.

## Slide 36

Panorama 2 de 3: Minhas artes, Estúdio, Exportar.
Não descreva tela por tela — deixe a imagem falar e diga que tudo saiu da mesma versão, no mesmo dia.
~30s.

## Slide 37

Panorama 3 de 3: Console do time, Tema Much+.
Não descreva tela por tela — deixe a imagem falar e diga que tudo saiu da mesma versão, no mesmo dia.
~30s.
