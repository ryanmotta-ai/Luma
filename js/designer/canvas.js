...
const dToolCursors = {
  ...
  'qr-code': `url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='%230A0A0A' stroke-width='2'><line x1='12' y1='2' x2='12' y2='22'/><line x1='2' y1='12' x2='22' y2='12'/><rect x='7' y='7' width='4' height='4' stroke='%23FF9000' stroke-width='1.2'/><rect x='13' y='7' width='4' height='4' stroke='%23FF9000' stroke-width='1.2'/><rect x='7' y='13' width='4' height='4' stroke='%23FF9000' stroke-width='1.2'/><rect x='13.5' y='13.5' width='3' height='3' fill='%23FF9000' stroke='none'/></svg>") 12 12, crosshair`,
  'magic-eraser': `url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='%230A0A0A' stroke-width='2' stroke-linecap='round'><path d='M20 20H7L3 16l10-10 7 7-2.5 2.5'/><line x1='3' y1='20' x2='20' y2='20'/><path d='M17 3l.9 2.1L20 6l-2.1.9L17 9l-.9-2.1L14 6l2.1-.9z' fill='%23FF9000' stroke='none'/></svg>") 4 20, cell`,
  ...
  // Família de CRIAÇÃO: cruz de precisão (preto) + glifo laranja do que a ferramenta cria.
  // Toda forma tem seu cursor — antes elipse/triângulo/polígono/estrela/linha caíam no crosshair
  // genérico (sem ícone), quebrando a consistência com retângulo/moldura/imagem.
  ...
  ellipse: `url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='%230A0A0A' stroke-width='2'><line x1='12' y1='2' x2='12' y2='22'/><line x1='2' y1='12' x2='22' y2='12'/><ellipse cx='12' cy='12' rx='5' ry='3.6' stroke='%23FF9000' stroke-width='1.5'/></svg>") 12 12, crosshair`,
  triangle: `url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='%230A0A0A' stroke-width='2'><line x1='12' y1='2' x2='12' y2='22'/><line x1='2' y1='12' x2='22' y2='12'/><polygon points='12 7 16.5 16 7.5 16' stroke='%23FF9000' stroke-width='1.5' stroke-linejoin='round'/></svg>") 12 12, crosshair`,
  polygon: `url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='%230A0A0A' stroke-width='2'><line x1='12' y1='2' x2='12' y2='22'/><line x1='2' y1='12' x2='22' y2='12'/><polygon points='12 7 16 9.5 16 14.5 12 17 8 14.5 8 9.5' stroke='%23FF9000' stroke-width='1.5' stroke-linejoin='round'/></svg>") 12 12, crosshair`,
  star: `url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='%230A0A0A' stroke-width='2'><line x1='12' y1='2' x2='12' y2='22'/><line x1='2' y1='12' x2='22' y2='12'/><polygon points='12 7 13.2 10.4 16.8 10.5 13.9 12.6 14.9 16.1 12 14 9.1 16.1 10.1 12.6 7.2 10.5 10.8 10.4' stroke='%23FF9000' stroke-width='1.3' stroke-linejoin='round'/></svg>") 12 12, crosshair`,
  line: `url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='%230A0A0A' stroke-width='2'><line x1='12' y1='2' x2='12' y2='22'/><line x1='2' y1='12' x2='22' y2='12'/><line x1='8' y1='16' x2='16' y2='8' stroke='%23FF9000' stroke-width='1.5' stroke-linecap='round'/></svg>") 12 12, crosshair`,
  ...
  'color-sampler': `url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='%230A0A0A' stroke-width='2'><line x1='12' y1='2' x2='12' y2='22'/><line x1='2' y1='12' x2='22' y2='12'/><circle cx='12' cy='12' r='4' stroke='%23FF9000' stroke-width='1.5'/><circle cx='12' cy='12' r='1' fill='%23FF9000' stroke='none'/></svg>") 12 12, crosshair`,
  'ruler': `url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='%230A0A0A' stroke-width='2' stroke-linecap='round'><line x1='4' y1='20' x2='20' y2='4'/><path d='M8 16l2 2M12 12l2 2M16 8l2 2' stroke-width='1.5'/><circle cx='4' cy='20' r='1.8' fill='%23FF9000' stroke='none'/></svg>") 4 20, crosshair`,
  'note': `url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='%230A0A0A' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M21 15a2 2 0 0 1-2 2H8l-4 4V5a2 2 0 0 1 2-2h13a2 2 0 0 1 2 2z'/><circle cx='12' cy='11' r='1.4' fill='%23FF9000' stroke='none'/></svg>") 3 3, cell`,
  'count': `url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='%230A0A0A' stroke-width='2' stroke-linecap='round'><line x1='12' y1='2' x2='12' y2='6'/><line x1='12' y1='18' x2='12' y2='22'/><line x1='2' y1='12' x2='6' y2='12'/><line x1='18' y1='12' x2='22' y2='12'/><circle cx='12' cy='12' r='5'/><path d='M12 9.7v4.6M9.7 12h4.6' stroke='%23FF9000' stroke-width='1.5'/></svg>") 12 12, crosshair`,
